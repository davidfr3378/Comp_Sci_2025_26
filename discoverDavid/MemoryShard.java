public class MemoryShard extends Item{
    ...
    private static final String[] messages = {
        ...
        "\t".repeat(tab_const) + "\nI have fair knowledge of Java and Python. \n" +"\t".repeat(tab_const) + " I used Java to make this, and made a mini data pipeline (specifically a Mini ETL pipeline) in Python. \n" +"\t".repeat(tab_const) + " I am not artisitc at all, as you can tell from this project. \n" +"\t".repeat(tab_const) + "",
